...
typedef struct {
  vector* set; //Pointer to the array of vectors
  int elemSize; //Size of element in hashset
  int size; //Size of hashset
  int numOfElems; //Number of elements in hashset
  HashSetHashFunction hashFn; //Hash function
  HashSetFreeFunction freeFn; //Free function
  HashSetCompareFunction compareFn; //Comparing function
} hashset;
