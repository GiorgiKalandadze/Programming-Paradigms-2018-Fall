...
typedef struct {
    void* array; //Pointer to the first element of vector
    int allocLength; //Size of vector
    int logicalLength; //Number of elements in vector
    VectorFreeFunction freeFn; //Free function
    int elemSize; //Size of element keeped in vector
} vector;
